...
public class ThrowsExample {
	...
	public static void main(String[] args) {
		try {
			findClass();
		} catch (ClassNotFoundException e) { // e: 예외 객체 변수명
			...
			System.out.println(e); // toString() 생략가능
			e.printStackTrace(); // 호출 스택을 추적하여 콘솔에 출력
	}
}
	// 직접 처리하지 않고 "호출한 쪽에소 다양한 방식으로 처리할 수 있도록" 예외 떠넘기기

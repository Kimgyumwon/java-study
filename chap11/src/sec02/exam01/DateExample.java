...
public class DateExample {
	...
	public static void main(String[] args) {
		...
		String strNow3 = sdf1.format(now); //원하는 날짜 포맷으로 문자열 반환
		...
		ZonedDateTime datezone = ZonedDateTime.now();
		...
		DateTimeFormatter format1 = DateTimeFormatter.ofPattern("yyyy년 MM월 dd일 a hh시 mm분 ss초");
